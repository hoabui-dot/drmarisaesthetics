 ...
 */
export function BookingModalWrapper({ children, serviceOptions = [], bookingForm }: { children: ReactNode, serviceOptions?: string[], bookingForm?: WebsiteSettingBookingForm }) {
    return (
