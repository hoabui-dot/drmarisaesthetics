    ...
    <section className="stitch-section stitch-treatment-landing__content">
      <div className="stitch-container stitch-treatment-content-grid">
        ...
        <div className="stitch-treatment-landing__article">
          <article id="overview" className="stitch-treatment-landing__block"><span className="stitch-kicker">{overview?.eyebrow || 'OVERVIEW'}</span><h2>{overview?.title || 'What is Rhinoplasty?'}</h2><div className="stitch-treatment-landing__image stitch-treatment-landing__image--mobile" aria-hidden="true"><ReferenceImage src={overviewImage} alt="" /></div><div className="stitch-treatment-landing__copy"><p>{overview?.paragraphOne || 'Rhinoplasty, commonly referred to as a nose job, is a highly refined surgical procedure designed to alter the shape, size, or proportions of the nose. At DR. MARIS AESTHETICS, we approach rhinoplasty not just as an aesthetic enhancement, but as a meticulous restructuring that honors your foundational facial architecture.'}</p><p>{overview?.paragraphTwo || 'Our philosophy is rooted in sterile warmth—combining surgical precision with a deep understanding of natural aesthetic harmony. Whether addressing cosmetic concerns or functional breathing issues, our goal is to create a result that looks entirely native to your face, enhancing your features without looking operated on.'}</p></div><div className="stitch-treatment-landing__image stitch-treatment-landing__image--desktop"><ReferenceImage src={overviewImage} alt={overview?.imageAlt || 'Patient consulting with a plastic surgeon in a premium medical consultation room'} /></div></article>
