...
export function TreatmentLandingPage() {
  ...
  return <main ref={pageRef} className="stitch-page stitch-treatment-landing">
    <section className="stitch-treatment-hero stitch-treatment-landing__hero">
      <div className="stitch-treatment-hero__copy stitch-treatment-landing__hero-copy">
        <span className="stitch-kicker stitch-treatment-landing__eyebrow"><i aria-hidden="true" /> <span>DR. MARIS AESTHETICS · FACIAL PROCEDURES</span></span>
        <h1>Rhinoplasty Surgery in Vietnam</h1>
        <p>At DR. MARIS AESTHETICS, we redefine nasal harmony through a meticulous structural approach that honors your unique facial architecture. Our surgical philosophy combines clinical precision with natural, balanced results that enhance your features without looking operated on, ensuring both aesthetic beauty and functional integrity.</p>
        <div className="stitch-treatment-review stitch-treatment-landing__review"><CheckCircle2 size={18} aria-hidden="true" />Reviewed by Dr. Maris · Ho Chi Minh City, Vietnam</div>
        <ConsultationButton />
      </div>
      <div className="stitch-treatment-hero__media stitch-treatment-landing__hero-media"><ReferenceImage src={images.hero} alt="Rhinoplasty procedure at DR. MARIS AESTHETICS" /></div>
    </section>
    ...
    <section className="stitch-section stitch-treatment-landing__content">
      <div className="stitch-container stitch-treatment-content-grid">
        <aside className="stitch-treatment-toc" aria-label="Treatment index"><span>Contents</span>{guide.map(([id, label], index) => <a href={`#${id}`} key={id}><b>{String(index + 1).padStart(2, '0')}</b><span>{label}</span></a>)}<div className="stitch-treatment-toc-card"><h4>Ready to discuss your goals?</h4><p>Schedule a private consultation with Dr. Maris.</p><ConsultationButton /></div></aside>
        <div className="stitch-treatment-landing__article">
          <article id="overview" className="stitch-treatment-landing__block"><span className="stitch-kicker">OVERVIEW</span><h2>What is Rhinoplasty?</h2><div className="stitch-treatment-landing__copy"><p>Rhinoplasty, commonly referred to as a nose job, is a highly refined surgical procedure designed to alter the shape, size, or proportions of the nose. At DR. MARIS AESTHETICS, we approach rhinoplasty not just as an aesthetic enhancement, but as a meticulous restructuring that honors your foundational facial architecture.</p><p>Our philosophy is rooted in sterile warmth—combining surgical precision with a deep understanding of natural aesthetic harmony. Whether addressing cosmetic concerns or functional breathing issues, our goal is to create a result that looks entirely native to your face, enhancing your features without looking operated on.</p></div><div className="stitch-treatment-landing__image"><ReferenceImage src={images.consultation} alt="Patient consulting with a plastic surgeon in a premium medical consultation room" /></div></article>
          <article id="concerns" className="stitch-treatment-landing__block"><h2>Designed Around Your Concerns</h2><div className="stitch-treatment-landing__concerns">{concerns.map(([title, copy]) => <div key={title}><h3><CheckCircle2 size={17} aria-hidden="true" />{title}</h3><p>{copy}</p></div>)}</div></article>
          <article ref={atlasRef} id="methodology" className="stitch-treatment-landing__block stitch-surgical-atlas"><header className="stitch-surgical-atlas__heading" data-atlas-entrance><h2>The Science of Rhinoplasty</h2><p className="stitch-treatment-landing__lead">Understanding the structural approach is key to achieving optimal results. Depending on your specific anatomical needs, we employ either an open or closed technique.</p></header><div className="stitch-surgical-atlas__layout"><div className="stitch-surgical-atlas__visual-wrap" data-atlas-entrance><div className="stitch-surgical-atlas__visual"><div className="stitch-surgical-atlas__image" data-atlas-image><ReferenceImage src={images.consultation} alt="Clinical consultation supporting rhinoplasty structural planning" /></div><span className="stitch-surgical-atlas__curtain" data-atlas-curtain aria-hidden="true" /><div className="stitch-surgical-atlas__wash" aria-hidden="true" /><svg className="stitch-surgical-atlas__overlay stitch-surgical-atlas__overlay--open" data-atlas-overlay="open" viewBox="0 0 400 500" aria-hidden="true"><path d="M116 160 C155 140 207 142 247 165 C270 179 278 199 274 220" fill="none" stroke="currentColor" strokeWidth="2" strokeDasharray="1000" strokeDashoffset="1000" data-atlas-trace="open" /><circle cx="274" cy="220" r="4" fill="currentColor" /></svg><svg className="stitch-surgical-atlas__overlay stitch-surgical-atlas__overlay--closed" data-atlas-overlay="closed" viewBox="0 0 400 500" aria-hidden="true"><path d="M142 176 C178 164 223 168 258 190 C271 199 279 211 280 224" fill="none" stroke="currentColor" strokeWidth="2" strokeDasharray="1000" strokeDashoffset="1000" data-atlas-trace="closed" /><circle cx="280" cy="224" r="4" fill="currentColor" /></svg><div className="stitch-surgical-atlas__meta" data-atlas-entrance><span>FIG. 01</span><strong>RHINOPLASTY / STRUCTURAL ACCESS</strong></div></div></div><div className="stitch-surgical-atlas__chapters"><article tabIndex={0} data-atlas-technique="open" data-atlas-entrance><span className="stitch-surgical-atlas__chapter-number">01</span><h3>Open Rhinoplasty</h3><p>Involves a small incision across the columella, providing full visibility of the nasal framework for intricate restructuring and precise modifications.</p><span className="stitch-surgical-atlas__rule" aria-hidden="true" /></article><article tabIndex={0} data-atlas-technique="closed" data-atlas-entrance><span className="stitch-surgical-atlas__chapter-number">02</span><h3>Closed Rhinoplasty</h3><p>All incisions are hidden inside the nostrils, resulting in no visible scarring and generally a faster initial recovery time, ideal for minor refinements.</p><span className="stitch-surgical-atlas__rule" aria-hidden="true" /></article></div></div></article>
        </div>
      </div>
    </section>
