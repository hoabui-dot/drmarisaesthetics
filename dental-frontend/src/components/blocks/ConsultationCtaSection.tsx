  ...
  return <section id={id} className="stitch-section stitch-consultation" data-motion-section="cta">
    ...
    <div className="stitch-container">
      <div className="stitch-consultation__copy">
        ...
        <div className="stitch-consultation__actions"><button type="button" className="booking-inline-cta stitch-button stitch-button--dark" onClick={open}>Start Your Consultation <ArrowRight size={16} /></button></div>
      </div>
