...
export const resultsMockData: ResultsData = {
  ...
  cases: [
    {
      caseNumber: '042', title: 'Deep Plane Facelift', subtitle: 'Combined with Neck Lift & Fat Grafting',
    ...
    {
      caseNumber: '089', title: 'Primary Rhinoplasty', subtitle: 'Dorsal Hump Reduction & Tip Refinement',
      beforeImage: 'https://lh3.googleusercontent.com/aida-public/AB6AXuAHPIrHmRYQ27MpPlYzMs6ZOzTAy9ZPT-n6_CpsVoFljhKS0UuYyKuZnc1jhe6bikE0MNpipvyyHA3MGIU_6dUJpQWC6JRHNH76X23Eo-Yv8w6mkV9D4SeR9hv6l4nZkF3veHsr5bMrTjeyhZehG6SGx3np6A3PAd-0ERZKXGFCHMPOSiRIPtbOp_41fTVDB9lKbZYjxfd7_ZRQ5zVWWm8DUZDrfIXEPLOXd0xX-b9UYDJv-qkBHb',
    ...
    {
      caseNumber: '112', title: 'Upper & Lower Blepharoplasty', subtitle: 'Skin Excision & Fat Repositioning',
    ...
    {
      caseNumber: '056', title: 'Isolated Neck Lift', subtitle: 'Platysmaplasty & Submental Liposuction',
  ...
  disclaimerLabel: 'Patient Image Disclaimer',
  disclaimer: 'The photographs in this gallery feature actual patients of Dr. Maris Aesthetic Surgery. Images are provided for illustrative purposes only and do not constitute a guarantee of results. Individual outcomes vary based on anatomy, healing, and adherence to post-operative protocols. All photos have been published with the explicit written consent of the patients.',
  ctaTitle: 'Begin Your Transformation',
  ctaDescription: 'Schedule a private consultation to discuss your aesthetic goals and discover what is surgically possible tailored specifically for you.',
}
