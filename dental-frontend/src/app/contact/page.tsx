...
import { getContactPage, getServiceOptions, getWebsiteSetting } from '@/src/lib/api/queries';
...
export default async function ContactPage() {
  const [content, websiteSetting, serviceOptions] = await Promise.all([
    getContactPage(true),
  ...
  return <><StructuredDataScript data={structuredData} /><ContactPageClient content={content} serviceOptions={serviceOptions} websiteSettings={{
